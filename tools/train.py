...
def main():
    ...
    if args.ckpt is not None:
        it, start_epoch = model.load_params_with_optimizer(args.ckpt, to_cpu=dist_train, optimizer=optimizer_lst, logger=logger)
        ...
        if len(ckpt_list) > 0:
            ...
            it, start_epoch = model.load_params_with_optimizer(
                ckpt_list[-1], to_cpu=dist_train, optimizer=optimizer_lst, logger=logger
            )
            last_epoch = start_epoch + 1
